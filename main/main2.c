...
void app_main(void) {
    ...
    eventbits_sem_handle = xSemaphoreCreateMutex();
    configASSERT(eventbits_sem_handle != NULL);
    ...
    led_handle = xTaskCreateStatic(led_task, "blink", 2048, NULL, 1, led_stack, &led_task_buffer);
